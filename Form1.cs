...
namespace _7_oop
{
    public partial class FormMain : Form
    {
        ...
        public FormMain()
        {
            ...
            commands[Keys.Add] = new ResizeCommand(5);
            commands[Keys.Subtract] = new ResizeCommand(-5);
        ...
        {
            if (e.KeyCode == Keys.A || e.KeyCode == Keys.D || e.KeyCode == Keys.W || e.KeyCode == Keys.S || e.KeyCode == Keys.Subtract || e.KeyCode == Keys.Add)
            {
